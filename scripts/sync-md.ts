...
// No runtime effect — marks this file as an ES module so top-level `await`
// below type-checks under tsc (a script with zero imports/exports is treated
// as a global script, where top-level await is a compile error).
export {};
