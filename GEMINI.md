...
> **Doc intent:** GEMINI.md = dev context. README.md = user onboarding. reports/ = research/history. contexts/ = session handoff. **memory/ = ABAP development history (archived by date).** **SKILL.md = Agent technical guidelines & custom skills.**
