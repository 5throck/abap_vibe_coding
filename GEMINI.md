...
> **Doc intent:** GEMINI.md = dev context. README.md = user onboarding. reports/ = research/history. contexts/ = session handoff. **MEMORY.md = ABAP development history.** **SKILL.md = Agent technical guidelines & custom skills.**
