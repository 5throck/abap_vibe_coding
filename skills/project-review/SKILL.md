...
- QA escalation: audit exits with 3+ ERRORs, or security-expert finds a Critical issue
...
| T-02: PM autonomous | PM agent | 3+ agent files modified; phase schema changed; new variant added |
| T-03: QA escalation | auditor / security-monitor | Audit ERROR ≥ 3; or security-expert Critical finding |
